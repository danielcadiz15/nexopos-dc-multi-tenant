...
const ReporteCompras = () => {
  ...
  const cargarReporteGeneral = async () => {
    try {
      ...
      const data = await reportesService.obtenerResumenCompras(filtros);
  ...
  const cargarComprasPorDia = async () => {
    try {
      ...
      const data = await reportesService.obtenerComprasPorDia(filtros);
  ...
  const cargarComprasPorProveedor = async () => {
    try {
      ...
      const data = await reportesService.obtenerComprasPorProveedor(filtros);
  ...
  const cargarProductosMasComprados = async () => {
    try {
      ...
      const data = await reportesService.obtenerProductosMasComprados(filtros);
